...
| Customer feedback intake | Customer Feedback Intake deterministic Action | Manual for demo; source triggers are a future adoption option |
| Customer feedback dedupe, strategy triage, and priority suggestion | Feedback Dedupe & Strategy Triage workflow | Manual for demo; feedback-intake trigger is a future adoption option |
