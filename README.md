...
| [📥 Slack Reaction Intake](.github/workflows/slack-reaction-intake.md) | Converts approved Slack emoji reactions in fixture data into labeled GitHub intake issues for normal triage | _Fixture-first MVP_ |
